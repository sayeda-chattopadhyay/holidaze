...
export default function AvatarModal() {
  ...
  return (
    <>
      <button
        className="bg-primary text-white hover:bg-primary-lighter font-bold uppercase text-sm px-6 py-3 mt-4 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
