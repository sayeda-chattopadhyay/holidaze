...
const CreateVenueForm = () => {
  ...
  const removeMedia = (index) => {
    ...
    return (
    <>
      <div className="container max-w-2xl mx-auto mt-20 px-20 py-20 shadow-lg">
        <h1 className="text-2xl text-center mb-20 border-b-4 border-secondary py-2 rounded-lg">
          Create Venue Form
        </h1>
        <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="py-3 flex flex-col justify-center flex-wrap">
                ...
                <div className="flex gap-3 my-4">
                  <button
                    type="button"
                    onClick={pushMedia}
                    className="bg-tertiary px-4 py-2 rounded hover:bg-tertiary-lighter shadow-md"
                  >
                    Add Media
                  </button>
                </div>
          ...
          <div>
            ...
            <button
              type="submit"
              className=" mt-4 flex w-full justify-center rounded-md bg-primary px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary-lighter focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Create Venue
            </button>
          </div>
