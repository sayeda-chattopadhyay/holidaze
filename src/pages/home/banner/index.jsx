...
const HeroBanner = () => {
  return (
    <section
      className="bg-center bg-no-repeat bg-cover relative h-[80vh] rounded-xl overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          <NavLink
            to="/venues"
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium font-heading text-center text-white rounded-lg bg-primary hover:bg-primary-darker focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
          >
            Explore Venues
          </NavLink>
        </div>
