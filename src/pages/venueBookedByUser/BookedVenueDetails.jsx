...
// This is the page that shows the specific venue booked by the user (host or guest). 
...
// const BookedVenueDetails = ({ booking }) => {
//   console.log(" Venue booked by users:", booking);
...
// export default BookedVenueDetails;
