...
const Card = ({ venue }) => {
  ...
  return (
    <Link to={`/Venues/${id}`} className="container mx-auto mt-8 w-80 h-full">
      <div className="max-w-sm rounded overflow-hidden shadow-md hover:bg-slate-100 hover:shadow-lg bg-grey-400 transition duration-300 transform hover:-translate-y-1">
        {media.length > 0 ? (
